...
const Header = () => {
  return (
    ...
    <p className='my-6 text-[15px] text-gray-600'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.<br className='max-sm:hidden'/> Lorem Ipsum has been the industry's standard dummy text ever.</p>
    <div>
